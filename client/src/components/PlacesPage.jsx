            ...
            {action === 'new' && (
                <div>
                    <form>
                        ...
                        <h1 className=" text-xl mt-4">Photos</h1>
                        ...
                        <div className=" mt-2 grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
                            <button className=" flex gap-1 justify-center border bg-transparent rounded-2xl p-8 text-2xl text-gray-600 shadow-md">
                        ...
                        <h1 className=" text-xl mt-4">Extra Info</h1>
                        <p className="text-gray-500 text-sm">House rules, ete.</p>
                        <textarea className="py-6" />

                        <h1 className=" text-xl mt-4">Check in&out Time</h1>
